...
public partial class GameRoomServiceTests
{
    ...
    public async Task GetRoomStatusTests(TestCase testCase){
        ...
        var exp = (IServiceResult<GameRoom>)testCase.Expected["service result"]!;

        act.Should().Be(exp, new ServiceResultEqaulityComparer<GameRoom>(
        ...
        // the same ID then the rest of the properties are
        // not going to matter.
        // act.Data!.Id.Should().Be(exp.Data!.Id);
    ...
    public static IEnumerable<object[]> GetRoomStatusTestsData => BundleTestCases(
        new TestCase("Found match only one record")
            ...
            .WithExpected(
                "service result",
                new ServiceResultBuilder<GameRoom>()
        ...
        , new TestCase("No match many records")
            ...
            .WithExpected(
                ...
                new ServiceResultBuilder<GameRoom>()
                    ...
                    .WithError("Could not find room with id '0b8b021e-40b5-43f8-a261-7c1c39d3661c'.")
                    .Create())
